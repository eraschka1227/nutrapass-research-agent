...
assert('follow-up prompt requests warmer tighter responses', /warm, kind, and helpful/.test(worker) && /55–110 words/.test(worker) && /Avoid wall-of-text responses/.test(worker));
